...
class AdaptiveControl(benchmark.Benchmark):
    ...
    def model(self, p):
        ...
        with model:
            ...
            if p.adapt:
                ...
                error_conn = nengo.Connection(control, adapt, synapse=None,
                        transform=1, modulatory=True)
    ...
    def evaluate(self, p, sim, plt):
        ...
        sys_q = np.array(self.system_state)
        ...
        diff = sim.data[self.p_desired][:-offset] - sys_q[offset:]
        diff = diff[N:]
