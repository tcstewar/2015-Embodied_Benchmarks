...
neuromorphic hardware perfroms well.  After all, it is unlikely that one
...
available at \texttt{http://github.com/ctn-waterloo/ctn_benchmarks}.
...
under programmer control.  Futhermore, SpiNNaker provides a custom I/O interface
