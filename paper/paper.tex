...
hardware).  Having such a metric across instances and algorithms will allow us
to quantitatively compare systems, letting
...
become \emph{impractical to run in realtime}.
This is a fundamental problem, in that most neuromorphic
...
fast enough to interact with most of the desired hardware would require more
...
we believe that the solution lies in an alternate approach taken from the
field of evolutionary robotics, known as \emph{Minimal Simulation}
