...
minimal simulation approach, there are three main steps: 1. identify
...
to record; 5. specify distributions for any parameters in the
...
impact performance.  Given that embodied models rely on real-time simulation,
...
to an environment.  However, that would not be useful for an embodied task.
